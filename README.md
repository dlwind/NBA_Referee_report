'referee_mistake.py' is sample code that scrap data from online NBA referee reports.
It reads link urls from 'link_per_game.xlsx' and save all correct/incorrect calls and non-calls from the each report into 'referee_mistake.xlsx'
